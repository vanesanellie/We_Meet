...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  Future<void> fetchData() async {
    ...
    getData().then((res) {
      setState(() {
        profileData = res;
        usernameInput.text = profileData[0]['Username'];
        descInput.text = profileData[0]['DescBox'];
        emailInput.text = profileData[0]['Email'];
        passwordInput.text = profileData[0]['Password'];
        imageBase64 = profileData[0]['ProfilePic'];
        if(profileData[0]['ProfilePic'] == null || profileData[0]['ProfilePic'] == ""){
          profilePic = base64.decode(base64Default);
        }
        else {
          profilePic = base64.decode(profileData[0]['ProfilePic']);
        }
      });
    });
  }
  ...
  Future<List> getData() async {
    String url = 'https://wemeetuntar.000webhostapp.com/Get_EditProfile.php';
  ...
  Future updateData() async {
    ...
    String url = 'https://wemeetuntar.000webhostapp.com/Update_Profile.php';
    if(imageBase64 == null){
      imageBase64 = "";
    }
    var data = {"username": usernameInput.text, "desc": descInput.text, "email": emailInput.text, "password": passwordInput.text, "profilepic": imageBase64};
    var response = await http.post(Uri.parse(url), body: (data));
    setState(() {
  ...
  Future<File> currfile;
  File tmpFile;

  chooseImage() async {
    tmpFile = await ImagePicker.pickImage(source: ImageSource.gallery);
    setState(() {
      imageBase64 = base64Encode(tmpFile.readAsBytesSync());
      profilePic = base64.decode(imageBase64);
    });
    //showImage();
  }
        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            //     fit: BoxFit.cover,
                            //     image: NetworkImage(
                            //       "https://www.somagnews.com/wp-content/uploads/2021/03/Rose-3.jpg",
                            //     ))
                        ),
                        child: ClipOval (
                          child: Image.memory(
              ...
              buildTextField("Username", "", false, true, usernameInput),
              buildTextField("Description", "", false, false, descInput),
              buildTextField("E-mail", "", false, false, emailInput),
              buildTextField("Password", "", true, false, passwordInput),
  ...
  Widget buildTextField(
      String labelText, String value, bool isPasswordTextField, bool isDisable, TextEditingController ctrl) {
    return Padding(
