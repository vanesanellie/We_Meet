...
class _Profil1State extends State<Profil1> {
  ...
  //   Uint8List tempFoto;
  //   tempFoto = base64.decode(newFeedData[index]['Image_Base64']);
  //   return Container(
  //     child: ClipOval (
  //       child: Image.memory(
  //         tempFoto,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: desc != null && bytes != null && friends != null && posts != null && isFetch == true ?
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: GridView.count(
                    ...
                    children: List.generate(newFeedData.length, (index) {
                      tempFoto = base64.decode(newFeedData[index]['Image_Base64']);
                      return Container(
                        decoration: BoxDecoration(
